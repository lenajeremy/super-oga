...
const LEVELS = [
  ...
  },
  {
    ...
    swim: true,
    time: 420,
    story: 'FASHE DEY MAKOKO WITH THE ASO-EBI. HIM BIG PASS YOU. GO COLLECT WETIN BE YOUR OWN.',
    tip: 'FASHE DEY WAIT FOR THE END. STOMP AM, PUNCH AM (X) - HIM NO GO FALL EASY.',
    host: 'ebun',
    goal: 'jetty',
    reward: 200,
    buildings: [],
