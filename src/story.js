...
// What Fashe shouts while he fights. He is a bus tout who robs people, not a demon, so
// the menace is all in the confidence.
const FASHE_THREATS = [
  'YOU FOLLOW ME COME MAKOKO? YOU GET LIVER.',
  'THIS WATER DEEP. NOBODY GO HEAR YOU SHOUT.',
  'I DEY COLLECT FROM PEOPLE LIKE YOU EVERY SINGLE DAY.',
  'THE CLOTH NA MY OWN NOW. GO BUY YOUR OWN ASO-EBI.',
  'YOU THINK SAY NA ONLY YOU DEY HUSTLE FOR THIS LAGOS?',
  'ONE CHANCE NO DEY DO TWO CHANCE. GO HOME.',
  'YOUR WEDDING GO START WITHOUT YOU. I GO SEND PICTURE.',
  'I DON THROW BIGGER MAN COMOT MOVING BUS.',
  'STAND STILL. E GO PAIN LESS THAT WAY.',
  'NA YOUR OWN CLOTH I GO USE WRAP YOU.',
];
...
const SCRIPTS = {
  ...
  ebun: () => ({
    start: { text: 'I SEE THE WHOLE THING FROM MY CANOE. NOBODY DEY FACE FASHE LIKE THAT.', next: 'b' },
    b: { text: 'HIM DON DEY COLLECT FROM PEOPLE FOR THIS WATER SINCE. TODAY SOMEBODY COLLECT BACK.', next: 'c' },
    c: { text: 'TWENTY-FIVE PIECE. I COUNT AM MYSELF WHILE YOU DEY CATCH YOUR BREATH.', next: 'd' },
